Public Class logovi
    Public Shared Sub Log()
        ...
        Log_File = My.Computer.FileSystem.OpenTextFileWriter("C:\\Users\\marce\\Documents\\GitHub\\Projekat-VB\\MainProgram\\ProjekatVB v1.0\\bin\\Logs\\Login\\Logs.txt", True)
    ...
    Public Shared Sub FailedLog()
        ...
        'promjeniti ime korisnika na Aleksandar ili marce (c:\Users\(jedno od ponudjenih imena)\...)
        Failed_Log = My.Computer.FileSystem.OpenTextFileWriter("C:\\Users\\marce\\Documents\\GitHub\\Projekat-VB\\MainProgram\\ProjekatVB v1.0\\bin\\Logs\\Login\\FailedLogs.txt", True)
    ...
    Public Shared Sub BrisanjeKorisnika()
        ...
        Try
            'promjeniti ime korisnika na Aleksandar ili marce (c:\Users\(jedno od ponudjenih imena)\...)
            Brisanje_Korisnika = My.Computer.FileSystem.OpenTextFileWriter("C:\\Users\\marce\\Documents\\GitHub\\Projekat-VB\\MainProgram\\ProjekatVB v1.0\\bin\\Logs\\Deleted\\ObrisaniKorisnici.txt", True)
