...
Public Class LogFile
    Public Shared Sub Log()
        ...
        Log_File = My.Computer.FileSystem.OpenTextFileWriter("C:\\Users\\IT\Desktop\\Projekat\\Imdonefore\\PaymentProgram\\Payment\\bin\\Debug\\Log.txt", True)
    ...
    Public Shared Sub FailedLog()
        ...
        Dim Log_Date As String
        Log_Date = Date.Now.ToString("dd-MMM-yyyy hh:mm:ss")
        Failed_Log = My.Computer.FileSystem.OpenTextFileWriter("C:\\Users\\IT\Desktop\\Projekat\\Imdonefore\\PaymentProgram\\Payment\\bin\\Debug\\FailedLogs.txt", True)
        If PaymentMethod_From.counter = 3 Then
