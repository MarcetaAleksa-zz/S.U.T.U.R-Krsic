...
Public Class LogFile
    ...
    Public Shared Sub Log()
        ...
        Log_File = My.Computer.FileSystem.OpenTextFileWriter("C:\\Users\\marce\\Documents\\GitHub\\Projekat-VB\\MainProgram\\ProjekatVB v1.0\\bin\\Logs\\Payment\\Log.txt", True)
    ...
    Public Shared Sub FailedLog()
        ...
        Failed_Log = My.Computer.FileSystem.OpenTextFileWriter("C:\\Users\\marce\\Documents\\GitHub\\Projekat-VB\\MainProgram\\ProjekatVB v1.0\\bin\\Logs\\Payment\\FailedLogs.txt", True)
        If PaymentMethod_From.counter = 1 Then
